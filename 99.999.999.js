...
// y lo recorre según el valor de index que le pasemos en el segundo argumento
function conversion(subcadenas, index){
    ...
    // creo una variable para trabajar con las recursiones con index > 0
    let recursionProxima = conversion(subcadenas, index + 1)
